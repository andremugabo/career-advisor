...
\vspace*{2cm}
\begin{center}
    \Large\bfseries\color{primary} DECLARATION
\end{center}
\vspace{1.5cm}
I, the undersigned, hereby declare that this research project entitled \textbf{``Optisource: Intelligent Resource Orchestration Platform for Emergency Department Optimization''} is my original work and has not been submitted to any other institution for the award of any academic qualification. All sources of information used in this work have been properly acknowledged.
\vspace{2cm}

\noindent \textbf{Name:} KATY Great Adonaï\\[1cm]
\noindent \textbf{Signature:} \rule{6cm}{0.4pt}\\[1cm]
...
\end{center}
\vspace{1.5cm}
I do hereby declare and affirm that the research project titled \textbf{``Optisource: Intelligent Resource Orchestration Platform for Emergency Department Optimization''} is entirely my own original work. I further certify that this work has not been presented or submitted to any other university or institution for the conferment of any degree or academic qualification. Any literature, data, or sources used have been duly cited and acknowledged.
\vspace{2cm}

\noindent \textbf{Name:} UMURERWA Lisa Ornella\\[1cm]
\noindent \textbf{Signature:} \rule{6cm}{0.4pt}\\[1cm]
\noindent \textbf{Date:} April 2026
\newpage
...
\end{center}
\vspace{1.5cm}
I solemnly declare that the dissertation bearing the title \textbf{``Optisource: Intelligent Resource Orchestration Platform for Emergency Department Optimization''} is the result of my independent research and original work. To the best of my knowledge, it does not contain any material previously published or submitted for the award of an academic degree at this or any other higher education institution, except where proper acknowledgment has been made.
\vspace{2cm}

\noindent \textbf{Name:} KALIZA GAJU Lauraine\\[1cm]
\noindent \textbf{Signature:} \rule{6cm}{0.4pt}\\[1cm]
\noindent \textbf{Date:} April 2026
\newpage
...
\end{center}
\vspace{1.5cm}
This is to certify and declare that the research study entitled \textbf{``Optisource: Intelligent Resource Orchestration Platform for Emergency Department Optimization''} is an authentic piece of work carried out by me. I attest that this project has never been submitted elsewhere for the attainment of any academic qualification, and all external sources of information utilized have been explicitly recognized and referenced.
\vspace{2cm}

\noindent \textbf{Name:} SINE Daella Lynda\\[1cm]
\noindent \textbf{Signature:} \rule{6cm}{0.4pt}\\[1cm]
\noindent \textbf{Date:} April 2026
\newpage
...
\end{center}
\vspace{1.5cm}
I hereby formally declare that I am the author of the research project titled \textbf{``Optisource: Intelligent Resource Orchestration Platform for Emergency Department Optimization.''} I confirm that this document represents my original academic work, it has not been used to acquire an academic degree or diploma at any other educational institution, and all third-party contributions and sources have been correctly cited.
\vspace{2cm}

\noindent \textbf{Name:} MUGABO André\\[1cm]
\noindent \textbf{Signature:} \rule{6cm}{0.4pt}\\[1cm]
\noindent \textbf{Date:} April 2026
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{diagrams/architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{diagrams/erd.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{diagrams/ai_flow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth,height=0.75\textheight,keepaspectratio]{diagrams/auth_flow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{diagrams/rbac.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{diagrams/frontend.png}
...
{\small
\begin{longtable}{p{1.3cm}p{5.5cm}p{6.5cm}}
\toprule
\textbf{Method} & \textbf{Endpoint} & \textbf{Description} \\
\midrule
\endhead
...
POST & \texttt{/api/profiles/share-report/} & Share AI report with advisor \\
GET & \texttt{/api/profiles/my-interventions/} & View advisor notes \& approvals \\
GET & \texttt{/api/profiles/list-advisors/} & List available advisors \\
GET & \texttt{/api/skills/} & List all skills (searchable) \\
GET/POST & \texttt{/api/skills/my/} & Student's skills CRUD \\
GET/POST & \texttt{/api/certifications/my/} & Student's certifications \\
...
GET & \texttt{/api/notifications/} & View advisor messages \\
\bottomrule
\end{longtable}
}
...
GET & \texttt{/api/advisors/students/analytics/} & System-wide analytics \\
POST & \texttt{/api/advisors/interventions/} & Log an intervention \\
GET & \texttt{/api/advisors/interventions/} & Intervention history \\
POST & \texttt{/api/notifications/} & Send message to student \\
\bottomrule
\end{longtable}
}
...
PATCH & \texttt{/api/admin/users/\textless id\textgreater/} & Update user \\
DELETE & \texttt{/api/admin/users/\textless id\textgreater/} & Delete user \\
...
\texttt{/advisor-notes} & Student & StudentInterventions \\
\midrule
