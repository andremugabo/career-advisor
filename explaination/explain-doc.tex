...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight,height=0.8\textwidth,keepaspectratio]{diagrams/architecture.png}
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight,height=0.8\textwidth,keepaspectratio]{diagrams/erd.png}
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight,height=0.45\textwidth,keepaspectratio]{diagrams/rbac.png}
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textheight,height=0.5\textwidth,keepaspectratio]{diagrams/frontend.png}
